...
public class ConsumerTest {
    ...
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        ...
        DslPart reqResBody = new PactDslJsonBody()
                .numberType("id", 123)
                .stringType("firstName", "Neelabh")
                .stringType("lastName", "Tiwari")
                .stringType("email", "neelabh@gmail.com");
    ...
    public void consumerTest() {
        ...
        reqBody.put("id", 123);
        reqBody.put("firstName", "Neelabh");
        reqBody.put("lastName", "Tiwari");
        reqBody.put("email", "neelabh@gmail.com");
